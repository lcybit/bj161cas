...
public class PlanController {
	...
	public List<PlanPo> lookById(@PathVariable("courseId") Integer courseId, @PathVariable("scheduleId") Integer scheduleId) {
	...
	public Map<String, String> change(@RequestParam("planId") Integer planid,@RequestParam("teacherId") Integer teacherid) {
		Integer num;
		Map<String, String> result = new HashMap<String, String>();
